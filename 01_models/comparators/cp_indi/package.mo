package A8FormalINDICommandProxyPlant20260712
  extends Modelica.Icons.Package;
  // 公共单机基座连接物理模型、传感器和CP-INDI控制器。
  ...
  model Scene04
    ...
    A8FormalINDICommandProxyV1A_20260712 controller
...
end A8FormalINDICommandProxyPlant20260712;
