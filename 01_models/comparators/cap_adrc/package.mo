package A8FormalADRCV11PX4AllocPlant20260712
  extends Modelica.Icons.Package;
  // 公共单机基座连接物理模型、传感器和CAP-ADRC控制器。
  ...
  model Scene04
    ...
    A8FormalADRCV11PX4AllocV1A_20260712 controller
...
end A8FormalADRCV11PX4AllocPlant20260712;
